...
namespace Microsoft.Azure.DataLake.Store.UnitTest
{
    ...
    public class RecordMatcherWithApiExclusion : IRecordMatcher
    {
        ...
        public RecordMatcherWithApiExclusion(bool ignoreResourcesClient, Dictionary<string, string> providers)
        {
            _ignoreGenericResource = ignoreResourcesClient;
            _providersToIgnore = providers;
        }

        public RecordMatcherWithApiExclusion(
